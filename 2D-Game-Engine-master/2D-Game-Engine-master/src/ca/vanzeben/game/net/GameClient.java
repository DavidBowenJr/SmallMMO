...
public class GameClient extends Thread {
    ...
    private void handleMove(Packet02Move packet) {
       // this.game.level.
                ...
                movePlayer(packet.getUsername(), packet.getX(), packet.getY(), packet.getNumSteps(),
    ...
    public synchronized void movePlayer(String username, int x, int y, int numSteps, boolean isMoving, int movingDir) {
        ...
        System.out.println("This App User Name is " + username + " void movePlayer ");

        int index = this.game.level.getPlayerMPIndex(username); // suppose to be private
        PlayerMP playerMP = (PlayerMP)  this.game.level.getEntities().get(index);              //this.getEntities().get(index);

        //   System.out.println("this.getEntities().get(index)" + this.getEntities().size());
        ...
        this.game.level.testPlayerCollision(username, x, y, numSteps, isMoving, movingDir);
    }
